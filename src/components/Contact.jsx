...
```
  ...
  >
    ...
    <div className="relative mx-auto max-w-4xl text-center">
      ...
      <span className="inline-block rounded-full border border-yellow-500/30 bg-yellow-500/10 px-5 py-2 text-sm font-medium tracking-wide text-yellow-400">
        DIRECT ENGAGEMENT
      </span>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                >
                  ...
                  <option>
                    Project Cost Audit & Overrun Control
                  </option>

                  <option>
                    IBBI Registered Asset Valuation
                  </option>

                  <option>
                    Insolvency & IBC Process Advisory
                  </option>
              ...
              <div>
                ...
                >
                  ...
                  <option>
                    Parmanand Goyal (Ex-ED IOCL)
                  </option>

                  <option>
                    Jagdish Lal Raheja (Ex-Group CFO)
                  </option>
                </select>
              </div>
